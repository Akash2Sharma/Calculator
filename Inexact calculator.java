...
/**
	...
	private JComboBox<?> fldOperand1Units = new JComboBox<Object>(unitNames);
	...
	private JComboBox<?> fldOperand2Units = new JComboBox<Object>(unitNames);
 ...
 * 
	...
	private void divOperands(ActionEvent ae){
		if (operandError)										// If there is an operand error just return
			return;
		if (Math.abs(operand2.getValue()) <= 1.0E-50) {					// Check to see if divide by zero
